...
public class DecisionServerHelloClient {
	...
	private static final String HELLO_RULE_ENDPOINT = "http://localhost:8080/kie-server/services/rest/server/containers/hello-container";
	...
	public void executeHelloCommand() throws Exception {
		...
		commands.add(new FireAllRulesCommand("hello-fire"));
